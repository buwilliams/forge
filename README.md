...
1. **`/forge:setup`:** set up your project's constitution (non-negotiable principles) and product spec (what and why). Do this once per project.
...
```
/forge:setup                             # set up constitution.md + product.md (once per project)
...
/forge:stop auth-system                  # pause a run and return to a clean state
